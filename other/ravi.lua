...
overbought = input (3, "Overbought", input.double, 0, 100, 1, false)
oversold = input (-3, "Oversold", input.double, -100, 0, 1, false)

source = input (inputs.close, "Source", input.string_selection,  inputs.titles)
fn     = input (averages.vidya, "Average", input.string_selection, averages.titles)
