instrument {
    ...
    show_hammer = input(true, "Show Bear/Bull Hammer",input.boolean)
    show_marubozu = input(true, "Show Marubozu",input.boolean)
    show_spinningtop = input(true, "Show Spinning Top",input.boolean)
    show_tweezer_tb = input(true, "Show Tweezer Top/Bottom",input.boolean)
    show_darckc = input(true, "Darck-Cloud and Piercing",input.boolean)
    ...
    show_3outside_up_dw = input(true, "Three outside Up and Down",input.boolean)
    show_3inside_up_dw = input(true, "Three Inside Up and Down",input.boolean)
    show_eve_mor_star = input(true, "Evening and Morning Star",input.boolean)
